        ...
        <aside className="controls">
          ...
          {gameMode === "strategy" ? <div className="strategy-command" aria-live="polite">
            ...
            <div className="strategy-player">
              ...
              {playerDossier?.manpower && <div className="manpower-card"><header><b>SIŁY ZBROJNE</b><span>dane wywiadu</span></header><div><span><small>Dysponujacy</small><b>{playerDossier.manpower.available}</b><small>na {playerDossier.manpower.active} aktywnych, {playerDossier.manpower.reserves} rezerwy</small></span><span><small>Koszt utrzymania</small><b>{playerDossier.manpower.maintenanceCost.toFixed(1)}</b><small>jednostek/kwartał</small></span><span><small>Mobilizacja</small><b>{playerDossier.manpower.mobilization === "hidden" ? "Ukryta" : playerDossier.manpower.mobilization === "open" ? "Jawna" : "Pełna"}</b><small>{playerDossier.manpower.mobilization === "full" ? "+35% obrony" : playerDossier.manpower.mobilization === "open" ? "+10-25% obrony" : "zwykła gotowość"}</small></span></div></div>}
